                    ...
                    <?php else: ?>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item"  href="<?php echo e(route('profile')); ?>" ><i class="bi bi-person-square"></i>
...
<?php /**PATH D:\atm_m\Praktikum\Modul8 lanjutan\resources\views/layouts/nav.blade.php ENDPATH**/ ?>